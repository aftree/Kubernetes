...
<!--
You can constrain a text="Pod" term_id="pod" >}} to only be able to run on particular
 text="Node(s)" term_id="node" >}}, or to prefer to run on particular nodes.
...
下面是一个使用节点亲和的 pod 的实例：
 ...
 file="pods/pod-with-node-affinity.yaml" >}}
...
### Pod 使用 pod 亲和 的示例：
 ...
 file="pods/pod-with-pod-affinity.yaml" >}}
