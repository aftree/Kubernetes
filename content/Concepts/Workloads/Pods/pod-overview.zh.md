...
Pod 表示部署单元：*Kubernetes 中应用程序的单个实例*，它可能由单个glossary_tooltip text="容器" term_id="container" >}} 或少量紧密耦合并共享资源的容器组成。
...
-->
一个 Pod 可以指定一组共享存储glossary_tooltip text="卷" term_id="volume" >}}。
