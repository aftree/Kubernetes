...
<!--
In Kubernetes, _scheduling_ refers to making sure that  text="Pods" term_id="pod" >}}
are matched to  text="Nodes" term_id="node" >}} so that
 term_id="kubelet" >}} can run them.
-->
在 Kubernetes 中，_调度_ 是指将  text="Pod" term_id="pod" >}} 放置到合适的
 text="Node" term_id="node" >}} 上，然后对应 Node 上的glossary_tooltip term_id="kubelet" >}} 才能够运行这些 pod。
...
-->
[kube-scheduler](/zh/docs/reference/command-line-tools-reference/kube-scheduler/) 是 Kubernetes 集群的默认调度器，并且是集群  text="控制面" term_id="control-plane" >}} 的一部分。如果你真的希望或者有这方面的需求，kube-scheduler 在设计上是允许你自己写一个调度组件并替换原有的 kube-scheduler。
