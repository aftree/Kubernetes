...
More details can be found [here](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/azure_disk/README.md).
-->
...
More details can be found [here](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/azure_file/README.md).
-->
...
<!--
See the [CephFS example](https://github.com/kubernetes/examples/tree/${githubbranch}/volumes/cephfs/) for more details.
-->
...
<!--
See the [FC example](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/fibre_channel) for more details.
-->
...
<!--
See the [Flocker example](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/flocker) for more details.
-->
...
<!--
See the [GlusterFS example](https://github.com/kubernetes/examples/tree/${githubbranch}/volumes/glusterfs) for more details.
-->
...
<!--
See the [iSCSI example](https://github.com/kubernetes/examples/tree/${githubbranch}/volumes/iscsi) for more details.
-->
...
<!--
See the [NFS example](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/nfs) for more details.
-->
...
see the [all-in-one volume design document](https://github.com/kubernetes/community/blob/${githubbranch}/contributors/design-proposals/node/all-in-one-volume.md).
-->
...
<!--
More details and examples can be found [here](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/portworx/README.md).
-->

更多详情和示例可以在[这里](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/portworx/README.md)找到。
...
See the [RBD example](https://github.com/kubernetes/examples/tree/${githubbranch}/volumes/rbd) for more details.
-->
...
<!--
For further detail, please see the [ScaleIO examples](https://github.com/kubernetes/examples/tree/${githubbranch}/staging/volumes/scaleio).
-->
