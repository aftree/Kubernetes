...
[Lease object](/docs/reference/generated/kubernetes-api//#lease-v1-coordination-k8s-io).
...
心跳有两种形式：`NodeStatus` 和 [`Lease` 对象](/docs/reference/generated/kubernetes-api//#lease-v1-coordination-k8s-io)。
每个节点在 `kube-node-lease`"命名空间" 中都有一个关联的 `Lease` 对象。
