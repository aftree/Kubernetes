...
* Service: A Kubernetes that identifies a set of Pods using label selectors. Unless mentioned otherwise, Services are assumed to have virtual IPs only routable within the cluster network.
 -->
...
[Ingress](/docs/reference/generated/kubernetes-api/ "version" >}}/#ingress-v1beta1-networking-k8s-io) 公开了从集群外部到集群内  link text="services" url="/docs/concepts/services-networking/service/" >}} 的 HTTP 和 HTTPS 路由。
...
<!--
You can secure an Ingress by specifying a ry_tooltip term_id="secret" >}}
